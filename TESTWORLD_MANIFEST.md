...
- **문항 수**: 11문항
- **소요시간**: 약 2분
- **결과 유형**: A(자기 꼬리를 먹는 뱀/우로보로스), B(거울의 방), C(채워지지 않는 항아리), D(가지 잃은 나무), E(뿌리 잃은 나무), F(탄탈로스), G(비밀의 방)
...
| `hell-test.html` | 2026-03-18 전면 개편: 7가지 신화형 지옥 유형(우로보로스/거울의 방/항아리/가지나무/뿌리나무/탄탈로스/비밀의 방), 질문 15→11문항으로 축소. scores A~G 7개 |
...
| 2026-03-18 | hell-test.html 전면 개편. 6→7 신화형 유형(A:우로보로스/B:거울의방/C:항아리/D:가지나무/E:뿌리나무/F:탄탈로스/G:비밀의방). 15→11문항 축소. 새 인트로 텍스트. TYPES 컬러 일신. |
